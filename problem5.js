...
function getCarsOlderThan2000(inventory) {
    number_of_cars_older_than_2000 = 0;
    cars_older_than_2000 = [];

    for (let i = 0; i < inventory.length; i++) {
        if (inventory[i].car_year < 2000) {
            cars_older_than_2000.push(inventory[i].car_model);
            number_of_cars_older_than_2000 += 1;
        }
    }

    return {
        count: number_of_cars_older_than_2000,
